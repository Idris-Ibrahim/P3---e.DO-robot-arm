...
def run_demo():
	...
	try:
		...
		device_manager.load_settings_json("C:/Users/caspe/OneDrive/Desktop/Github/P3-e.DO-robot-arm/Realsense_FULL/wrappers/python/examples/box_dimensioner_multicam/HighResHighAccuracyPreset.json")
